...
/* harmony import */ var _modules_valid__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_valid__WEBPACK_IMPORTED_MODULE_5__);
...
document.addEventListener('DOMContentLoaded', function () {
  var tabs = document.querySelectorAll('[data-ticket-tab]');
...
window.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('[data-form]').forEach(function (form) {
    ...
    var phone = form.querySelector('[data-tel]');
    form.addEventListener('submit', function (evt) {
      if (!validatePhone(phone.value) || !validateName(name.value)) {
        ...
        evt.preventDefault();
        phone.classList.remove('is--error');
        name.classList.remove('is--error'); // Тут отправить форму Ajax'ом
      }
    });
  });
});
...
document.querySelectorAll('[data-video]').forEach(function (video) {
  ...
  btn.addEventListener('click', function (e) {
    e.preventDefault();
    var src = iframe.dataset.src; // скрываем постер

    video.classList.add('is-active'); // подставляем в src параметр из data
